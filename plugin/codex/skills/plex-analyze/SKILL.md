...
<!-- GENERATED from agents/plex-analyzer.md by scripts/gen-codex-skills.mjs — do not edit here; edit the source and re-run. -->
...
## 0. Use the Plex tools (don't hand-distill)

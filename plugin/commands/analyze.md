...
- **Incremental:** re-run to keep working through history. By default it takes your most recent PRs;
  pass `--oldest` to go chronologically from PR #1, `--limit <n>` to bound a run, `--reset` to start over.
